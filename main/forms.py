...
class RegisterUserForm(forms.ModelForm):
    ...
    def clean_password1(self):
        ...
        # self.cleaned_data - это словарь с данными формы, которые прошли начальную валидацию и очистку.
        if password1:
    ...
    def save(self, commit=True):
        ...
        # Отправляем сигнал, передавая ему класс формы и объект пользователя.
        return user
